...
export function createSidebar(map: L.Map, config: Config) {
  ...
  if (sidebarHome) {
    ...
    if (home) {
      ...
      eo4cLink.innerHTML = '<a href=""><img class="mr-4" style="width: 5rem; height: 5rem;" title="EO4 Cultivar" ' +
        'alt="EO4 Cultivar" src="' + require('../images/eo4c.jpg') + '"></img></a>'
      sponsorLinks.appendChild(eo4cLink)

      let uksaLink = L.DomUtil.create('span', '')
      uksaLink.innerHTML = '<a href=""><img class="mr-4" style="width: 7rem;" title="UK Space Agency" '
